    ...
    <body class="antialiased">
        ...
        <style>
            body {
                font-family: 'Nunito', sans-serif;
                margin: 0;
                padding: 20px; /* Added padding for the entire body */
                display: flex;
                flex-wrap: wrap;
            ...
            <div class="recipe-card">
                ...
                <aside>
                    <?php if($recipe->image_path): ?>
                        <img src="<?php echo e(asset('images/recipes/' . $recipe->image_path)); ?>" alt="Recipe Image">
                    <?php else: ?>
                        No Image
                    <?php endif; ?>
                    <div>
                        <p class="ingredients"><span><?php echo e($recipe->description); ?></span></p>
                        <a href="<?php echo e(route('recipe.view')); ?>" class="btn btn-danger">View More</a>
                    </div>
                </aside>
            </div>
...
<?php /**PATH C:\Users\youcod\Desktop\LARAVEL2\Recipe_book\resources\views/welcome/welcome.blade.php ENDPATH**/ ?>